        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VacationDaysPlanned = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    EarlyReleaseID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    EarlyReleaseDateTime = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    TimeMissed = table.Column<float>(type: "float", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EarlyReleases", x => x.EarlyReleaseID);
                    table.ForeignKey(
                        name: "FK_EarlyReleases_AspNetUsers_ApplicationUserID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EarlyReleases_ApplicationUserID",
                table: "EarlyReleases",
