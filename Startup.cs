...
namespace SimpleSchedule
{
    public class Startup
    {
        ...
        {
            string mySqlConnectionStr = Configuration.GetConnectionString("SimpleScheduleDBConnection");
            ...
            //services.AddMvc();
            services.AddScoped<IRequestRepository, SQLRequestRepo>();
            services.AddScoped<IEarlyReleaseRepository, SQLEarlyReleaseRepo>();
            services.AddScoped<IHolidayRepository, SQLHolidayRepo>();
        }
